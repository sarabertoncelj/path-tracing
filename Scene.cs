...
namespace PathTracer
{
  public class Scene
  {
    ...
    public static Scene CornellBox()
    {
      ...
      s.Elements.Add(new DiffuseAreaLight(new Sphere(60, Transform.Translate(278, 490, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 20));
      ...
      el = new Sphere(130, Transform.Translate(200, 150, 320));
      el.BSDF.Add(new SpecularTransmission(Spectrum.ZeroSpectrum.FromRGB(Color.White), 1, 1.5));
